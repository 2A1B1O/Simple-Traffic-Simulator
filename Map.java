...
public class Map implements Serializable {
	...
	public void RemoveRoad() {
		// arrayin sadece so elemaný deðil, istenilen elemaný silinmeli . arada
		// boþluklar kalabilir mi ?
		// öyleyse içine aldýðý elemaný arraylistte bulmak için önce search
		// yapýp sonra silicek? diðerleriyle Tartýþ.
	}
